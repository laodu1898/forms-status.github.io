        ...
        var squareblock=function(){
            square[0].style.display="inline-block";
            present1[0].style.display="none"
        };
        //弱密码变色
        ...
        inputs[2].onkeyup=function(){
            if( this.value == "")
                { present[2].innerHTML="密码不能为空";present[2].style.display="block"}
            else if (inputs[2].value!==inputs[1].value)
                {   present[2].innerHTML="两次输入不一致";
                    present[2].style.color="red";
                    present[2].style.display="block";
                }
            else {confirm[2]=true
                present[2].innerHTML="两次输入一致";
                present[2].style.color="green";
                present[2].style.display="block";
            };
        };
        ...
        inputs[4].onkeyup=function(){
            ...
            else if (reg[5].exec(this.value)){
                confirm[4]=true;present[4].innerHTML="身份证号码输入正确";
                present[4].style.color="green";
                present[4].style.display="block";};
        };
